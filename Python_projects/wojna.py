...
class Card:
    ...
    values = [None,None,"2","3","4","5","6","7","8","9","10","waleta","dame","krola","asa"]

    def __init__(self,value,suit):
        """listy suit i value to liczby calkowite"""
        self.value = value
        self.suit = suit
...
class Game:
    ...
    def play_game(self):
        ...
        print("Wojna skonczona - wygral {}".format(win))
